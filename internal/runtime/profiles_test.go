...
var pinnedLifecycleProfileRows = []lifecycleProfileRow{
	...
	{"claude-code", "PreModelSwitch", "observation", "claude-command-json", "nonblocking", "none", "concurrent-native", "none", "report-and-continue", "report-and-continue", "", "not-applicable", "session:session_id:required", ""},
