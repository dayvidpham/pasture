...
// vocabulary. For the recorded Codex version this is exactly ["request-input"]. Deriving the
...
//     The Codex contract classifies only `request-input`, so an emitted profile that
